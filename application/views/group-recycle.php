    <div class="col-xs-8 my_post">
        ...
        <form method="post" action="<?php echo base_url();?>user/back_all">
        <div class="col-xs-12">
            <table class="table table-hover table-condensed">
                ...
                <tr>
                    ...
                    <td>
                    <a href="<?php echo base_url();?>user/back?pid=<?php echo $user_post['pid'];?>">恢复</a> 
        ...
        <div class="col-xs-12">
        	<a class="btn btn-sm btn-success" id="checkall" onclick="allCkb('ckb')"><span class="glyphicon glyphicon-arrow-down"></span>全选</a>
            <a class="btn btn-sm btn-success" id="delcheckall" onclick="unAllCkb()"><span class="glyphicon glyphicon-ban-circle"></span>全不选</a>  选中项： 
            <button class="btn btn-sm btn-success"><span class="glyphicon glyphicon-refresh"></span>恢复</button> 
        </div>
        </form>
