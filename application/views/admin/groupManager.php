        ...
        <div class="col-xs-7">
        	...
        	<div class="panel panel-info" id="shadow1">
            	<div class="panel-heading">
              		<h3 class="panel-title">审核通过的社团负责人列表，数目：<span class="badge"><?php echo $PowerUserNum;?></span></h3>
            	</div>
            	<div class="panel-body">
                    ...
                    <div class="col-xs-12">
                        ...
                        <button onClick="javascript:form1.action='<?php echo base_url();?>youth_admin/check_all?fromurl=3';delcfm('是否确定取消审核？')" id="check" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-ok"></span> 取消审核状态</button>  
                        <button onClick="javascript:form1.action='<?php echo base_url();?>youth_admin/delete_all?fromurl=3';delcfm('确定要彻底删除？')" id="delete" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-trash"></span> 删除</button>
                    </div>
                    </form>
